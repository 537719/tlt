...
# MODIF 13/04/2018 - 11:49:13 - remplacement de l'écriture des \t par l'utilisation de la fonction tabu() du module inclus, et beautification du code source
...
END {
    ...
    print tabu(4) "<tr>"
    print tabu(5) "<td width=\"640px\">"
    print tabu(6) "<a href=\"" fichier ".png\">"
    print tabu(7) "<img style=\"border: 0px solid ; width: 640px; height: 480px;\" src=\"" fichier ".png\" alt=\"Graphique de stat sur fichier\">"
    print tabu(6) "</a>"
    print tabu(5) "</td>"
    print tabu(5) "<td style=\"align: center;\">"
    print tabu(6) "<a href=\"../webresources/" fichier ".jpg\">"
    print tabu(7) "<img style=\"border: 0px solid ; width: 320px;\" src=\"../webresources/" fichier ".jpg\" alt=\"illustration de " fichier "\">"
    print tabu(6) "</a>"
    print tabu(5) "</td>"
    print tabu(5) "<td>"
    print tabu(6) "<a href=\"" fichier ".png\">"
    ...
    print tabu(4) "</tr>"
    print tabu(4) "<tr>"
    print tabu(5) "<td><object type=\"text/plain\" data=\"" fichier ".txt \" style=\"overflow: hidden;\" border=\"0\" height=\"100\" width=\"640\"></object><br>"
    print tabu(5) "</td>"
    print tabu(5) "<td><object type=\"text/plain\" data=\"../webresources/" fichier ".txt \" style=\"overflow: hidden;\" border=\"0\" height=\"100\" width=\"640\"></object><br>"
    print tabu(5) "</td>"
    print tabu(4) "</tr>"

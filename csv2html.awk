...
BEGIN { # Définition des parties du header qui peuvent être écrites dès maintenant
  ...
  print "		<title>"titre "</title> <!-- modifier ici -->"
  print "		<meta name=\"Description\" content=\"" titre "\"> <!-- modifier ici -->"
  print "		<meta name=\"Subject\" content=\"" titre "\"> <!-- modifier ici -->"
  ...
  print "		<meta name=\"Geography\" content=\"920100 Montrouge, France\">"
  print "		<meta name=\"generator\" content=\"csv2html.awk " ARGV[1] "\" />"
...
NR==1 { # traitement de la ligne d'en-tête
  ...
  print "							<h2>" titre " au "
  print "								<object type=\"text/plain\" data=\"date.txt\" style=\"overflow: hidden;\" border=\"0\" height=\"20\" width=\"100\"></object>"
  print "							</h2>"

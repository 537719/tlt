...
BUG     23/10/2018 - 17:23:07 la modification précédente était un bug : il y a justement besoin de compter les multiples occurences identiques !
...
REM grep -f liveGLPIprojects.csv "%workdir%\is_out_all.csv" |usort  -n -t; -k18 -k1 -k6|gawk -F; "$1~ /^[0-9]{10}$|^GLPI$/ {print $1 FS $8 FS $18 FS $6 FS $7}" |uniq >projexped.csv

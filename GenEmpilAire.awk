...
NR==1 {
    ...
    # avec ce système on peut générer 18 couleurs distinctes ce qui est déjà beaucoup, plus serait inutile, graphique illisible
        ...
        signeR= modulo(k,3)-1   # en fonction de la variable, rend la série -1 -1 -1 0 0 0 1 1 1
        signeV= modulo(i-1,3)-1 # en fonction de la variable, rend la série  0 -1 1 0 -1 1 0 -1 1 
        signeB= modulo(j,3)-1   # en fonction de la variable, rend la série -1 -1 0 0 1 1 -1 -1 0 0 1 1

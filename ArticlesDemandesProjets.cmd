...
REM @echo GLPI;qte;reference;designation> ArticlesDemandesProjets.csv
...
del ArticlesDemandesProjets.csv 2>nul
@echo Extraction des références et quantités demandées
for /F %%I in (GLPIliveprojectsNumbers.csv) do sqlite3 projets.db "select content from dossiers where id='%%I';"  |gawk -f .\ArticlesDemandesProjets.awk -v dossier=%%I >> ArticlesDemandesProjets.csv
